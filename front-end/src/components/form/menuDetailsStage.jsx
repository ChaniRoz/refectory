...
function MenuDetailsStage() {
    ...
    const [menuDetails, setMenuDetails] = React.useState(true);
        ...
        <div>
            {!showPaymentStage && !showPrev && (
                <FormControl component="fieldset"
                    ...
                    <div>
                        <Button variant="contained" color="primary" onClick={handleSaveAndNext}>For payment</Button>
                        <Button variant="contained" color="secondary" onClick={handlePrev}>Previous</Button>
                    </div>
                </FormControl>
            )}
            {showPaymentStage && !showPrev && (
